...
model = build_net(num_res=4)

model.eval()

state = torch.load("/home/giovannidistasio/vista/models/ConvIR/Image_deraining/small_version_LHP_RR_LW/ConvIR/train/Best.pkl", weights_only=True, map_location="cpu")
...
torch.onnx.export(
    ...
    "convIR_rain.onnx",                       # nome file di output
