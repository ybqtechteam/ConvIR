...
def main(args):
    ...
    model = build_net(num_res=4)  # Adjust num_res as needed
...
if __name__ == '__main__':
    ...
    # Directories
    parser.add_argument('--model_name', default='myconvir_Noresume_small_fixed_input', type=str)
    parser.add_argument('--data_dir', type=str, default='dataset/train/RealRain-1k/RealRain-1k-L/train')
    parser.add_argument('--valid_data', type=str, default='dataset/train/RealRain-1k/RealRain-1k-L/validation')
